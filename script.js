...
const typed = new Typed('.multiple-text', {
    strings: ['Frontend Developer', 'Researcher', 'Photographer', 'Gamer'],
    typeSpeed: 100,
    backSpeed: 100,
    backDelay: 1000,
    loop: true
...
/*==================== read more toggle ====================*/
// Get the Read More button and the extra text div
const readMoreButton = document.querySelector('.about-content .btn');
const extraText = document.querySelector('.about-content .extra-text');
...
readMoreButton.addEventListener('click', function(event) {
  ...
  readMoreButton.textContent = extraText.style.display === 'none' ? 'Read More' : 'Read Less';
});
